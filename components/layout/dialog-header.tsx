...
export function DialogHeader({
  ...
  return (
    <div className="h-[64px] flex flex-row items-center justify-between px-5 gap-3 bg-zinc-white border-b border-zinc-200/80">
      <div className="flex items-center gap-2.5 min-h-8">
        <h2 className={cn("text-lg font-medium inline-flex text-zinc-800")}>
          {title}
        </h2>
        {pill && (
